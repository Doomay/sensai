...
const contrastText =
    TextStyle(color: kPrimaryLightColor, fontFamily: 'Poppins');
...
const inputFieldTextStyle = TextStyle(
    fontFamily: 'Poppins', fontWeight: FontWeight.w400, color: Colors.white);

const inputFieldHintTextStyle =
    TextStyle(fontFamily: 'Poppins', color: Colors.white);

const inputFieldLabelTextStyle =
    TextStyle(fontFamily: 'Poppins', color: Colors.white);
...
const inputFieldDefaultBorderStyle = UnderlineInputBorder(
    borderRadius: BorderRadius.all(
      Radius.circular(6),
    ),
    borderSide: BorderSide(color: Colors.grey));

const enabledInputBorderStyle = UnderlineInputBorder(
